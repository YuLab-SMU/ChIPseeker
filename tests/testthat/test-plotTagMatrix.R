...
test_that("test plotPeakProf2 function use txdb",{
  ...
  p1_2 <- plotPeakProf2(peak = peak_list,
                        upstream = 1000,
                        downstream = 1000,
                        by = "gene",
                        type = "start_site",
  ...
  # test body region
  # without extension
  p2_1 <- plotPeakProf2(peak = peak_list,
                        by = "gene",
                        type = "body",
                        TxDb = txdb,
                        nbin = 800)
  ...
  p2_2 <- plotPeakProf2(peak = peak_list,
                        by = "gene",
                        type = "body",
                        TxDb = txdb,
                        upstream = rel(0.2),
  ...
  p2_3 <- plotPeakProf2(peak = peak_list,
                        by = "gene",
                        type = "body",
                        TxDb = txdb,
                        upstream = 1000,
